...
# Load data
day_df = pd.read_csv("felixtaslim2/analisis_data_bikesharing/main/dashboard/day_cleaned.csv")
hour_df = pd.read_csv("felixtaslim2/analisis_data_bikesharing/main/dashboard/hour_cleaned.csv")
